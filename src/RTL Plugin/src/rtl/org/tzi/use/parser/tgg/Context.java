 ...
 */
// the context for tgg rules - hanhdd
...
public class Context {
	 ...
	 * @uml.associationEnd  
	 */
    private MSystemState fCurrentSystemState; // the LHS or RHS of the tgg rule
    /**
	 * @uml.property  name="fSystemState_LHS"
	 * @uml.associationEnd  
	 */
    private MSystemState fSystemState_LHS; // the LHS of the tgg rule
    /**
